...
public class TypeUtils {
    ...
    public static Class getGenericParameterClass(final Class<?> actualClass,
        ...
        while (true) {
            ...
            Type rawType = isParametrizedType ? ((ParameterizedType) genericSuperclass).getRawType() : genericSuperclass;
        ...
        if (result instanceof TypeVariable) {
            ...
            throw new IllegalStateException("Unable to resolve type variable " + result + "."
                    + " Try to replace instances of parametrized class with its non-parametrized subtype.");
        }
